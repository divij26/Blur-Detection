...
3. I have not used the scaled folder for this implementation.
4. It took a lot of time to download the dataset so I was only able to start coding last night.
5. First few cells are commented out since I was not able to apply them in my work due to time constraint.
